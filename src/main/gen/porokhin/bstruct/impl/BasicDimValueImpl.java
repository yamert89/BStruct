...
public class BasicDimValueImpl extends ASTWrapperPsiElement implements BasicDimValue {

  public BasicDimValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BasicVisitor visitor) {
    visitor.visitDimValue(this);
  }
  ...
  public BasicParam getParam() {
    return findNotNullChildByClass(BasicParam.class);
  }
