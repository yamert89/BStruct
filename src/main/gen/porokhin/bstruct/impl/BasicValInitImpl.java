...
public class BasicValInitImpl extends ASTWrapperPsiElement implements BasicValInit {

  public BasicValInitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BasicVisitor visitor) {
    visitor.visitValInit(this);
  }
  ...
  public BasicValue getValue() {
    return findNotNullChildByClass(BasicValue.class);
  }
